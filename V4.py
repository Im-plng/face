...
def menu():
    ...
    print '>>\x1b[1;92m SHAZE TOOLE KURDISH HACK VIP \x1b[1;91m(\x1b[1;97mV4\x1b[1;91m) '
    print 42 * '\x1b[1;91m='
    action()
...
def action():
    ...
    time.sleep(0.1)
    psb('\x1b[1;91m[\xe2\x9c\x93]\x1b[1;94m RAWSTA TA CHAND DAQEAK......')
    time.sleep(0.1)
    psb('AM TOOLA BA XATE FTTH KORAK ASIA TP LINK NEW NET ZOR BASHA')
    time.sleep(0.5)
    print 42 * '\x1b[1;91m='
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;93m[NO ACC]\x1b[1;96m ' + k + c + user + ' >>> ' + pass1 + '\n'
